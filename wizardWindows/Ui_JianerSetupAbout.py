...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.NormalIconButton_2.setObjectName("VersionCard_2")
        ...
        self.NormalIconButton_4.setObjectName("VersionCard_4")
        ...
        self.NormalIconButton.setObjectName("VersionCard_1")
        ...
        self.NormalIconButton_3.setObjectName("VersionCard_3")
        ...
        self.NormalIconButton_5.setObjectName("VersionCard_5")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "小依 - 关于"))
        self.LargeTitleLabel.setText(_translate("Form", "关于"))
        self.TitleLabel.setText(_translate("Form", "小依 Demo v3"))
        ...
        self.TitleLabel_3.setText(_translate("Form", "主要功能"))
        self.SubtitleLabel_4.setText(_translate("Form", "AI智能对话、自动群管理、娱乐互动、有趣的插件系统和自定义工作流"))
        self.TitleLabel_5.setText(_translate("Form", "更新内容"))
        self.SubtitleLabel_6.setText(_translate("Form", "新增AI多模型支持、优化群管机制、提升系统稳定性和丰富的自定义选项"))
        self.TitleLabel_2.setText(_translate("Form", "小依 Version 3.0.0"))
        self.SubtitleLabel_3.setText(_translate("Form", "基于OneBot v11协议的智能QQ群机器人，集成AI对话、群管功能和娱乐插件"))
        self.TitleLabel_4.setText(_translate("Form", "技术架构"))
        self.SubtitleLabel_5.setText(_translate("Form", "基于Python开发，支持多种AI模型，提供丰富的插件接口和灵活的配置选项"))
        self.TitleLabel_6.setText(_translate("Form", "版权声明"))
        self.SubtitleLabel_7.setText(_translate("Form", "版权所有 © 2025 思锐工作室，遵循GPLv3开源协议。欢迎访问GitHub了解更多详情"))
