...
DEFAULT_CONFIG = {
    ...
    "数据存储路径": os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "check_in"),
...
class CheckInManager:
    def __init__(self):
        try:
            ...
            check_in_data_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "check_in")
            users_dir = os.path.join(check_in_data_dir, "users")
            ...
            print(f"[签到系统]配置路径: {os.path.abspath(check_in_data_dir)}")
            raise e
    ...
    def _load_or_create_config(self):
        # 使用项目根目录的data文件夹
        data_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "check_in")
        config_path = os.path.join(data_dir, "check_in_config.json")
        try:
